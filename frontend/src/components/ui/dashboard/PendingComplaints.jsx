...
const PendingComplaints = ({ complaints, onViewAll, onViewComplaint }) => {
  ...
  return (
    <div className="warden-section-card warden-complaints-card">
      <div className="warden-complaints-header">
        ...
        <button className="warden-view-all-btn" onClick={onViewAll}>View All Complaints</button>
      </div>
      <div className="warden-complaints-list">
        {list.map((c) => (
          <div key={c.id} className="warden-complaint-item">
            ...
            <div className="warden-complaint-meta">
              ...
              <button
                className="warden-complaint-view-btn"
        ...
        {list.length === 0 && (
          <div className="warden-complaint-item">
            <div className="warden-complaint-main">
              <p className="warden-complaint-title">No pending complaints found in database.</p>
            </div>
          </div>
        )}
      </div>
