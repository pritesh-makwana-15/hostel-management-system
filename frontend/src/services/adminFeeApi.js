...
export const studentFeeApi = {
  ...
  submitPaymentRequest: (data) => api.post('/api/student/fees/request', data),
  submitPayment: (data) => api.post('/api/student/fees/request', data),
  getPayments: () => api.get('/api/student/fees/payments'),
  getPaymentById: (paymentId) => api.get(`/api/student/fees/payments/${paymentId}`),
  getFeeDetails: () => api.get('/api/student/fees'),
  getPaymentHistory: () => api.get('/api/student/fees/payments'),
};
...
export const adminFeesApi = {
  ...
  refundPayment: (paymentId, notes) =>
    api.put(`/api/admin/fees/payments/${paymentId}/refund`, { notes }),
};
